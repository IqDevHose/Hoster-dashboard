...
const AddPlan: React.FC = () => {
  ...
  const mutation = useMutation({
    mutationFn: (data: FormData) =>
      axiosInstance.post(`/plans-dashboard`, data),
  ...
  const onSubmit = (data: FormData) => {
    ...
    if (
      ...
      setError(
        "Please fill in both English and Arabic title and description fields."
      );
      return;
    }
          ...
          {advantages.map((advantage, index) => (
            <div key={index} className="flex gap-3 items-center">
              <input
                ...
                onChange={(e) =>
                  handleAdvantageChange(index, "en", e.target.value)
                }
              ...
              <input
                ...
                onChange={(e) =>
                  handleAdvantageChange(index, "ar", e.target.value)
                }
                className="border rounded p-2 w-full"
              />
              <Button
